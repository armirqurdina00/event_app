...
describe('FacebookScraper.', function () {
  ...
  describe('Tests for FacebookScraper.', function () {
    ...
    it.skip('Should fetch other event URLs from repeating event', async function () {
  ...
  describe.skip('Debug FacebookScraper.', function () {
    ...
    it('Debug.', async function () {
      ...
      // const events = await this.Scraper.fetchEventUrlsFromOrganizerUrl(
      //   'https://www.facebook.com/salsa.akademie.heidelberg'
      // );
