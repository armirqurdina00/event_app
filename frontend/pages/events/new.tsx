          ...
          <div className="mt-5 flex flex-wrap justify-center gap-5 px-3">
            <div className="flex w-full flex-nowrap justify-between gap-4">
              <DatePicker
                ...
                label={t('events:new-event.date-label')}
                slotProps={{
                  textField: {
                    fullWidth: true,
                    required: true,
            ...
            <MobileTimePicker
              ...
              label={t('events:new-event.time-label')}
              slotProps={{
                textField: {
                  fullWidth: true,
                  required: true,
            ...
            <TextField
              ...
              id="outlined-basic"
              name="event-title"
              label={t('events:new-event.title-label')}
              variant="outlined"
              fullWidth
              required
            ...
            <TextField
              ...
              id="outlined-basic"
              name="event-location"
              label={t('events:new-event.location-label')}
              variant="outlined"
              fullWidth
              required
            ...
            <TextField
              ...
              label={t('events:new-event.details-label')}
              variant="outlined"
              multiline
              fullWidth
              rows={15}
